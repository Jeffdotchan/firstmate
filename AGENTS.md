...
state/               runtime records and signals; gitignored
  ...
  <id>.reconcile-nudged  epoch second of the last inventory-reconcile nudge sent to this secondmate; bin/fm-secondmate-reconcile.sh owns its format and cooldown, and bin/fm-teardown.sh owns retirement with the endpoint state
