...
: > "$PARENT/state/ios.reconcile-nudged"
...
assert_absent "$PARENT/state/ios.reconcile-nudged" \
  "remote retirement left a reconciliation cooldown that could suppress a replacement nudge"
